 ...
 * @Date: 2019/3/20 0020 22:52
 * @Description:
 */
public class ReleaseGridRvDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public ReleaseGridRvDividerDecoration(Context context) {
        // 获取默认主题的属性
