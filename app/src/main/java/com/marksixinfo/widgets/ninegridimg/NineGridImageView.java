...
public class NineGridImageView<T> extends ViewGroup {
    ...
    public NineGridImageView(Context context, AttributeSet attrs) {
        ...
        boolean isRounded = typedArray.getBoolean(R.styleable.NineGridImageView_isRounded, false);
        typedArray.recycle();
        mAdapter = (NineGridImageViewAdapter<T>) new NineGridAdapter(isRounded);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mImgDataList != null && mImgDataList.size() > 0) {
            ...
            if (mImgDataList.size() == 1) {
                height = (int) (mGridSize / 1.7f + mGap * (mRowCount - 1) + getPaddingTop() + getPaddingBottom());
            } else {
    ...
    private void layoutForNoSpanChildrenView(int childrenCount) {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            bottom = top + (b ? getMeasuredHeight() : mGridSize);
    ...
    public void setImagesData(boolean isRounded, List<T> lists, ItemImageClickListener<T> itemImageViewClickListener) {
        this.mItemImageClickListener = itemImageViewClickListener;
        if (isRounded) {
            if (mAdapter != null && mAdapter instanceof NineGridAdapter) {
                ((NineGridAdapter) mAdapter).setRounded(true);
            }
        }
        setImagesData(lists, NOSPAN);
    }
    ...
    public void setImagesData(List<T> lists, ItemImageClickListener<T> itemImageViewClickListener) {
        this.mItemImageClickListener = itemImageViewClickListener;
        setImagesData(lists, NOSPAN);
    }
    ...
    static class NineGridAdapter extends NineGridImageViewAdapter<String> {

        private boolean isRounded;//圆角

        public void setRounded(boolean rounded) {
            isRounded = rounded;
        }

        public NineGridAdapter(boolean isRounded) {
        ...
        protected void onDisplayImage(Context context, ImageView imageView, String s) {
            if (isRounded) {
                GlideUtil.loadRoundedImage(s, imageView);
            } else {
