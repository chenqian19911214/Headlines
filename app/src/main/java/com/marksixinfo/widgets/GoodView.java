...
public class GoodView extends PopupWindow implements IGoodView {
     ...
     * @param text
     */
    public GoodView setText(String text) {
     ...
     * @param color
     */
    public GoodView setTextColor(int color) {
        mTextColor = color;
     ...
     * @param textSize
     */
    public GoodView setTextSize(int textSize) {
        mTextSize = textSize;
     ...
     * @param textSize
     */
    public GoodView setTextInfo(String text, int textColor, int textSize) {
