...
//        if (verticalScrollFlag)return true;
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (verticalScrollFlag) {
                    ...
                    LogUtils.v(TAG, "滚动判断:" + mDirection + "  " + isStickied());
    ...
    public void setMyScroll(boolean myScroll) {
        this.myScroll = myScroll;
    }

    public boolean isMyScroll() {
        return myScroll;
    }
...
//        log("scrollTo " + x + "  " + y);
        ...
        mCurY = y;
        if (onScrollListener != null && !myScroll) {
            onScrollListener.onScroll(mCurY, maxY);
        }
        super.scrollTo(x, y);
    }
...
//                Integer.MAX_VALUE);
    ...
    public void smoothScroll(int from, int to, boolean isDown) {
        mScroller.abortAnimation();
        LogUtils.d("***************************" + from + "*************" + to + "***********" + isDown);
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                int y;
                if (isDown) {
                    y = (int) (from + (v * (to - from)));
                } else {
                    y = (int) (from - (v * (from - to)));
                }
//                if (!isDown && to == 0 && y <= 0) {
//                    mCurY = 0;
//                }
