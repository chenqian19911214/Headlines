...
//        Bitmap bitmap = CommonUtils.decodeResource(getContext(), resid);
//        String base64 = CommonUtils.toBase64(bitmap);
//        bitmap.recycle();
//
...
//        Bitmap bitmap = CommonUtils.toBitmap(background);
//        String base64 = CommonUtils.toBase64(bitmap);
//        bitmap.recycle();
//
//        exec("javascript:RE.setBackgroundImage('url(data:image/png;base64," + base64 + ")');");
...
//        exec("javascript:RE.prepareInsert();");
//        exec("javascript:RE.setTodo('" + CommonUtils.getCurrentTime() + "');");
//    }
//
...
//            isReady = url.equalsIgnoreCase(SETUP_HTML);
            if (mLoadListener != null) {
                mLoadListener.onAfterInitialLoad(true);
            }
        }
