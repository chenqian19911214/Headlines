package com.marksixinfo.widgets.dockingexpandablelistview.view;
...
import com.marksixinfo.widgets.dockingexpandablelistview.controller.IDockingController;
...
public class DockingExpandableListView extends ExpandableListView implements OnScrollListener {
    ...
    private boolean isExpandGroupAll;//是否展开所有
    ...
    public boolean isExpandGroupAll() {
        return isExpandGroupAll;
    }

    public void setExpandGroupAll(boolean expandGroupAll) {
        isExpandGroupAll = expandGroupAll;
    }
}
