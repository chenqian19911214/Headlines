package com.marksixinfo.widgets.swipeback;
...
import com.marksixinfo.widgets.swipeback.tools.Util;
...
//            UIUtils.setStatusBarColor(activity, activity.getResources().getColor(R.color.no_color));
//        } else {
//            UIUtils.setStatusBarColor(activity, activity.getResources().getColor(R.color.colorPrimary));
//        }
    }
    ...
    public void setSwipeBackEnable(boolean mEnable) {
