package com.marksixinfo.widgets.bigimageViewpage.glide;
...
import com.marksixinfo.widgets.bigimageViewpage.glide.cache.DataCacheKey;
import com.marksixinfo.widgets.bigimageViewpage.glide.cache.SafeKeyGenerator;
...
//            File file = new File(context.getCacheDir(), DiskCache.Factory.DEFAULT_DISK_CACHE_DIR);
            File file = new File(context.getCacheDir(), context.getString(R.string.markSixImageCache));
