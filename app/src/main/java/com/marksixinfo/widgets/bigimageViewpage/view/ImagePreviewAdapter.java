package com.marksixinfo.widgets.bigimageViewpage.view;
...
import com.marksixinfo.base.ImagePreviewActivity;
...
import com.marksixinfo.widgets.bigimageViewpage.glide.FileTarget;
import com.marksixinfo.widgets.bigimageViewpage.glide.ImageLoader;
import com.marksixinfo.widgets.bigimageViewpage.glide.sunfusheng.progress.OnProgressListener;
import com.marksixinfo.widgets.bigimageViewpage.glide.sunfusheng.progress.ProgressManager;
import com.marksixinfo.widgets.bigimageViewpage.tool.utility.common.NetworkUtil;
import com.marksixinfo.widgets.bigimageViewpage.tool.utility.image.ImageUtil;
import com.marksixinfo.widgets.bigimageViewpage.tool.utility.ui.PhoneUtil;
import com.marksixinfo.widgets.bigimageViewpage.tool.utility.ui.ToastUtil;
import com.marksixinfo.widgets.bigimageViewpage.view.helper.FingerDragHelper;
import com.marksixinfo.widgets.bigimageViewpage.view.helper.ImageSource;
import com.marksixinfo.widgets.bigimageViewpage.view.helper.SubsamplingScaleImageViewDragClose;
import com.marksixinfo.widgets.bigimageViewpage.view.photoview.PhotoView;
...
public class ImagePreviewAdapter extends PagerAdapter {
    ...
    private int initProgress = new Random().nextInt(6) + 1;//原图加载初始进度
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        final CircleProgressBar progressBar = convertView.findViewById(R.id.progress_view);
...
//        progressBar.setVisibility(View.VISIBLE);
        ...
        if (cacheFile != null && cacheFile.exists()) {
            ...
            // 显示加载圈圈
            progressBar.setVisibility(View.VISIBLE);
            progressBar.setProgress(initProgress); //初始进度
            //先显示缩略图
            File glideCacheFile = ImageLoader.getGlideCacheFile(activity, thumbPathUrl);
            if (glideCacheFile != null && glideCacheFile.exists()) {
                loadImageSpec(glideCacheFile.getAbsolutePath(), imageView, imageGif);
            }
            //加载原图
            ...
            ProgressManager.addListener(url, new OnProgressListener() {
                @Override
                public void onProgress(String url, boolean isComplete, int percentage, long bytesRead,
                                       long totalBytes) {

                    if (percentage < initProgress) {// 初始进度
                        return;
                    }
                    ...
                    LogUtils.d("ProgressManager____" + percentage);
    ...
    private void loadFailed(SubsamplingScaleImageViewDragClose imageView, ImageView imageGif, View progressBar,
                            GlideException e) {
...
//        }
    ...
    private void loadImageSpec(final String imagePath, final SubsamplingScaleImageViewDragClose imageView,
                               final ImageView imageGif, final View progressBar) {
