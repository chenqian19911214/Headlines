 ...
 * @Description:
 */
public class CommWhiteTitle extends ViewBase {

    TextView tvBack;
    TextView tvTitle;
    TextView tvFunction;

    public CommWhiteTitle(Context context) {
        super(context);
    }

    public CommWhiteTitle(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CommWhiteTitle(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    protected CommRedTitle.OnBackListener onBackListener;

    public interface OnBackListener {
        void back();
    }

    public void setOnBackListener(CommRedTitle.OnBackListener onBackListener) {
        this.onBackListener = onBackListener;
    }

    @Override
    public int getViewId() {
        return R.layout.view_title_white;
    }
     ...
     * @date: 2019/4/17 0017 14:28
     */
    public void init(String title, boolean isBack, String back, String function, int selectResId, OnClickListener functionListener) {
