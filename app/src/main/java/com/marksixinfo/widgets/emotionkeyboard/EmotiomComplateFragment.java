 ...
 * @Date: 2019/3/21 0021 15:10
 * @Description:
 */
public class EmotiomComplateFragment extends MarkSixFragment {
...
//    }
    ...
    protected void initView() {
        ...
        //获取map的类型
        emotion_map_type = getArguments().getInt(FragmentFactory.EMOTION_MAP_TYPE);
        initEmotion();
    }
    ...
    private void initEmotion() {
        ...
        // item的间距
        int spacing = UIUtils.dip2px(getActivity(), 12);
        // 动态计算item的宽度和高度
