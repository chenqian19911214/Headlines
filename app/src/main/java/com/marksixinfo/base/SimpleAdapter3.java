...
public abstract class SimpleAdapter3<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public SimpleAdapter3(ActivityIntentInterface context, List<T> mData, int itemLayoutId) {
    ...
    public SimpleAdapter3(ActivityIntentInterface context, List<T> mData, int itemLayoutId, OnItemClickListener listener) {
        this.mContext = context;
        this.mInflater = LayoutInflater.from(mContext.getContext());
        this.mData = mData;
        this.mItemLayoutId = itemLayoutId;
