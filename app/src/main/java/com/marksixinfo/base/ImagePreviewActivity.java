...
import com.marksixinfo.widgets.bigimageViewpage.tool.utility.common.HandlerUtils;
import com.marksixinfo.widgets.bigimageViewpage.tool.utility.image.DownloadPictureUtil;
import com.marksixinfo.widgets.bigimageViewpage.tool.utility.ui.ToastUtil;
import com.marksixinfo.widgets.bigimageViewpage.view.HackyViewPager;
import com.marksixinfo.widgets.bigimageViewpage.view.ImagePreviewAdapter;
import com.marksixinfo.widgets.bigimageViewpage.view.listener.OnBigImageLongClickListener;
...
public class ImagePreviewActivity extends AppCompatActivity implements Handler.Callback,
        View.OnClickListener, OnBigImageLongClickListener, SucceedCallBackListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImagePreview.getInstance().setBigImageLongClickListener(this);
    }
...
//        ((Vibrator) context.getSystemService(Context.VIBRATOR_SERVICE)).vibrate(100);//短震动
        if (CommonUtils.StringNotNull(currentItemOriginPathUrl)) {
            CommonUtils.copyText(context, currentItemOriginPathUrl);
//            ClipboardManager cm = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
//            ClipData clipData = ClipData.newPlainText("text", currentItemOriginPathUrl);//text是内容
...
//            ToastUtil.getInstance()._short(context, "复制成功");
    ...
    public boolean onLongClick(View view, int position) {
        ...
        simpleDialog.show("保存图片", "复制图片链接", this);
        return true;
    }
