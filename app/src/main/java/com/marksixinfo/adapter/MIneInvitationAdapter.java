 ...
 * @Description:
 */
public class MIneInvitationAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public MIneInvitationAdapter(Context context, List<MainHomeData> list, IMainHomeRecommend iMainHomeRecommend) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return ViewHolder.createViewHolder(context, parent, R.layout.item_mine_invitation);
    }
