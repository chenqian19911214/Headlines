 ...
 * @Description:
 */
public class GallerySearchStartFragment extends MarkSixFragment {
    ...
    public int getViewId() {
        return R.layout.fragment_gallery_search_start;
    }
    ...
    private void getHotSearch() {
        new GalleryImpl(new MarkSixNetCallBack<List<SearchHotKeyWord>>(this, SearchHotKeyWord.class) {
            @Override
        ...
        commonDialog.show(getString(R.string.clear_search_history), "", "取消", "确定", null, new
                View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        SPUtil.removeSearchGalleryHistory(getContext());
